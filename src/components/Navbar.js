...
const Navbar = () => {
    ...
    return (
     ...
     alt="logo" height={40}  /> FloresHoy</h1>
        ...
        <div onClick={handleNav} class="block md:hidden p-4 w-[90%]">
            {!nav ? 'X' : <StaticImage src="../images/bars-solid.svg"
     alt="Menu" height={50} />}
          <div class={!nav ? "fixed left-0 top-0 w-[50%] h-full border-r border-r-gray-900 bg-gray-100 m-4 ease-in-out duration-500" 
     : "fixed left-[-100%]"}>
     <h1 class="w-full text-3xl font-bold p-4"><StaticImage src="../images/logo-floresHoy.png"
     alt="logo" height={40}  /> FloresHoy</h1>
